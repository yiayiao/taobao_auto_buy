...
class TM_Market(AutoBuyBase):
    ...
    def _buy(self):
        ...
        sumit_element = WebDriverWait(self._browser, 20).until(
            EC.presence_of_element_located((By.XPATH, "//a[@data-tmc='cart' and @class='tm-mcCartBtn']")))
        sumit_element = WebDriverWait(self._browser, 20).until(
            EC.element_to_be_clickable((By.XPATH, "//a[@data-tmc='cart' and @class='tm-mcCartBtn']")))
    ...
    def _checkout(self):
        ...
        checkout_element = WebDriverWait(self._browser, 60).until(
            EC.presence_of_element_located((By.XPATH, "//div[@id='submitOrderPC_1']//a[@class='go-btn']")))
